...
class adjust_contrast(object): 
    def __init__(self, alpha_min=0, alpha_max=1, beta_min=1.5, beta_max=3.5, p_alpha=0.75, p_beta=0.75): 
...
class AddFrame: 
    ...
    def get_square_frame(self): 
        ...
        X[self.d//2-irange//2:self.d//2+irange//2 + 1, self.d//2-irange//2:self.d//2+irange//2 + 1] = X_inside
