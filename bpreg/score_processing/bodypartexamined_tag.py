...
BODY_PARTS_INCLUDED = {
    ...
    "ABDOMEN": ["L5", "L4", "L3", "L2", "L1", "Th12", "Th11", "Th10", "Th9"],  # TODO document 7/9
    "CHEST":  ["Th12", "Th11", "Th10", "Th9", "Th8", "Th7", 
                "Th6", "Th5", "Th4", "Th3", "Th2", "Th1"], 
    "NECK": ["Th3", "Th2", "Th1", "C7", "C6", "C5", "C4", "C3", "C2"], 
    "HEAD": ["C3", "C2", "C1", "eyes_end"] 
    }

MIN_PRESENT_LANDMARKS= {
    "PELVIS": 2, 
    "ABDOMEN": 7, 
    "CHEST": 9, 
    "NECK": 6, 
...
class BodyPartExaminedTag: 
    def __init__(self, 
        ...
        self.body_parts_included_scores = get_scoreDict(self.body_parts_included, lookuptable)
        self.distinct_body_parts_scores = get_scoreDict(self.distinct_body_parts, lookuptable)
    ...
    def is_bodypart_present(self, scores:np.array, landmark_scores, landmark_threshold) -> bool: 
        landmarks_inside = 0
